...
export type OasesRole='SCAN_OPERATOR'|'EVALUATOR'|'HEAD_EXAMINER';
export type AccessClaims={sub:string;schoolId?:string;role?:SchoolRole;type:'school'|'platform'|'platform_mfa';permissions?:Permission[];profileId?:string;profileType?:'STUDENT'|'TEACHER'|'STAFF'|'GUARDIAN';oasesRoles?:OasesRole[];mustChangePassword?:boolean};
