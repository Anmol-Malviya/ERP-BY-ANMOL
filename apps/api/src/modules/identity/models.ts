...
const UserSchema=new Schema({
 ...
 passwordHash:{type:String,required:true,select:false},firstName:{type:String,required:true,trim:true},lastName:{type:String,default:'',trim:true},
 role:{type:String,required:true,index:true},permissions:[{type:String}],profileType:{type:String,enum:['STUDENT','TEACHER','STAFF','GUARDIAN']},profileId:{type:Schema.Types.ObjectId,index:true},oasesRoles:[{type:String,enum:['SCAN_OPERATOR','EVALUATOR','HEAD_EXAMINER']}],isActive:{type:Boolean,default:true,index:true},
